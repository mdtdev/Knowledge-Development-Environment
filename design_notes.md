...
4. **Implementation**: An implementation is a specific combination of strategy, standard(s), and tool(s). The goal of an implementation is to make the use of a particular strategy easy for people to do.# Design Notes
